...
func TestAccountRequest(t *testing.T) {
	...
	metrixClient.Accounts = append(metrixClient.Accounts, exampleAcc1, exampleAcc2)

	//preparing proxy & executing request
	proxyEth := ProxyETHAccounts{metrixClient}
...
func TestAccountToResponse(t *testing.T) {
	...
	proxyEth := ProxyETHAccounts{metrixClient}
	callResponse := metrix.CallContractResponse{
