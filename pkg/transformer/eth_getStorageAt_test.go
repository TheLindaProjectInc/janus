...
func TestGetStorageAtRequestWithNoLeadingZeros(t *testing.T) {
	...
	getStorageResponse := metrix.GetStorageResponse{}
	...
	err = mockedClientDoer.AddResponseWithRequestID(2, metrix.MethodGetStorage, getStorageResponse)
	if err != nil {
		t.Fatal(err)
	}

	//preparing proxy & executing request
	proxyEth := ProxyETHGetStorageAt{metrixClient}
