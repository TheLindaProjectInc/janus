...
func (p *ProxyETHGetFilterLogs) request(filter *eth.Filter) (metrixresp eth.GetFilterChangesResponse, err error) {
	...
	if !ok {
		return metrixresp, errors.New("Could not get toBlock")
	}
