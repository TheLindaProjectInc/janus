...
var DefaultGasAmountForMetrix = big.NewInt(250000)

// METRIX default gas value (also the minimum gas) in wei
var DefaultGasPriceInWei = big.NewInt(5000000000000)
...
func (r *SendTransactionRequest) UnmarshalJSON(data []byte) error {
	...
	*r = SendTransactionRequest(params[0])
	...
	if r.Gas == nil {
		...
		// METRIX: (numeric or string, optional) gasLimit, default: 250000, max: 40000000
		r.Gas = &ETHInt{DefaultGasAmountForMetrix}
	}

	if r.GasPrice == nil {
		// ETH: (optional, default: To-Be-Determined) Integer of the gasPrice used for each paid gas
		// METRIX: (numeric or string, optional) gasPrice Metrix price per gas unit, default: 0.00005000, min:0.00005000
