...
func (r *SendToAddressRequest) MarshalJSON() ([]byte, error) {
	/*
		1. "address"            (string, required) The metrix address to send to.
		2. "amount"             (numeric or string, required) The amount in METRIX to send. eg 0.1
...
func (r *SendToContractRequest) MarshalJSON() ([]byte, error) {
	/*
	   ...
	   5. gasPrice  (numeric or string, optional) gasPrice Metrix price per gas unit, default: 0.0000004, min:0.0000004
...
func (r *CreateContractRequest) MarshalJSON() ([]byte, error) {
	/*
		...
		3. gasPrice  (numeric or string, optional) gasPrice MRX price per gas unit, default: 0.0000004, min:0.0000004
...
// Calculates transaction total amount of Metrix
...
type (
	/*
		     ...
		     [
		       {                              (json object)
		         "address": amount,           (numeric or string, required) A key-value pair. The key (string) is the metrix address, the value (float or string) is the amount in MRX
		       },
		       {                              (json object)
		       ...
		       {                              (json object) (send to contract)
		         ...
		         "amount": amount,            (numeric or string, optional, default=0) Value in MRX to send with the call, should be a valid amount, default 0
		         "gasLimit": n,               (numeric) The gas limit for the transaction
		         "gasPrice": n,               (numeric) The gas price for the transaction
		         "senderaddress": "hex",      (string) The metrix address that will be used to create the contract.
		       },
...
type (
	/*
		...
		1. Input params              (json object, required) Json object
			{
			"addresses": [        (json array, required) The metrix addresses
...
type (
	...
	/*
		Arguments:
		1. addresses       	(json array, required) The metrix addresses
			[
				"address",	(string) The metrix address
				...
			]
