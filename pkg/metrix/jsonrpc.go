...
func (err *JSONRPCError) Error() string {
	return fmt.Sprintf("metrix [code: %d] %s", err.Code, err.Message)
}
...
var (
	...
	// taken from https://github.com/TheLindaProjectInc/Metrix/blob/master/src/rpc/protocol.h
	...
	ErrMetrixWorkQueueDepth = errors.New("Work queue depth exceeded")
	// TODO: add
